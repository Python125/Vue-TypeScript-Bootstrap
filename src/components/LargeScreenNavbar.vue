    ...
    <div class="top-navbar d-flex">
      ...
      <div class="dropdown help-dropdown d-flex">
        <div class="help-selection">
          <div class="help-text">
            <button class="caret-btn text-white" type="button" @click="toggleDropdown('help')">Help</button>
          </div>
        </div>
        <svg id="gds-svg-598" width="13" height="11" viewBox="0 0 16 11" version="1.1" focusable="false" class="mt-1">
          <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
